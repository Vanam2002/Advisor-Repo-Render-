...
async def next_page(bot, query):
    ...
    btn.insert(0, 
        [
            InlineKeyboardButton('🔋 Hᴏᴡ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ 🔋', url='https://t.me/ARmovies_world/120')
        ]
    )
    btn.insert(1, 
        [
            InlineKeyboardButton('ɢʀᴏᴜᴘ', url='https://t.me/+xqfxWxoePGs4ZWJl'),
            InlineKeyboardButton('ᴄᴏɴᴛᴀᴄᴛ', url='https://t.me/Anand_2K')
        ]
    )
...
async def cb_handler(client: Client, query: CallbackQuery):
        ...
        if chat_type == enums.ChatType.PRIVATE:
            ...
            if grpid is not None:
                ...
                try:
                    ...
                    return await query.answer('♥️ Sᴜᴘᴘᴏʀᴛ  ᴀʀ ᴍᴏᴠɪᴇs ᴡᴏʀʟᴅ ♥️')
            else:
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            InlineKeyboardButton('🔥 ᴄʜᴀɴɴᴇʟ 🔥', url='https://t.me/ARmovies_world'),
            InlineKeyboardButton('💥ʀᴇǫᴜᴇsᴛ ᴍᴏᴠɪᴇs ♥️', url='https://t.me/+xqfxWxoePGs4ZWJl')
            ],[
            InlineKeyboardButton('💞 sᴜᴘᴘᴏʀᴛ 💞', url='https://t.me/+xqfxWxoePGs4ZWJl'),
            InlineKeyboardButton('👩‍💻 ʀᴇᴘᴏ ✨', url='https://t.me/Anand_2K'),
            ],[
        ...
        buttons = [[
            InlineKeyboardButton('😎 ᴏᴡɴᴇʀ 😎', url='https://t.me/Anand_2K'),
            InlineKeyboardButton('🔥 ᴄʜᴀɴɴᴇʟ 🔥', url='https://t.me/ARmovies_world'),
        ],[
            InlineKeyboardButton('👩‍💻 sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ 👩‍💻', url='https://t.me/Anand_2K'), #Please Change your bot username
